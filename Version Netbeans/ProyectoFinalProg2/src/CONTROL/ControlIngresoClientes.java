...
public class ControlIngresoClientes {
    ...
    public void setValues(JTextField japellido, JTextField jdni, JTextField jdireccion, JTextField jnombre, JTextField jlocalidad, JTextField jtelefono, JComboBox indexAuto) throws ConversionExcep, AñoExcep, CamposNulosExcep {
        int codigo;
        String es;
